...
这是nigo（公众号：逆行的狗）制作的一套面向审计、财务、会计从业者的 AI Skills（技能）。安装后 AI 助手将具备资深专家的分析视角与一整套实战工具，覆盖会计准则判断、审计实务、财报分析、关联方核查、报告勾稽、法规检索等高频场景。

## 关于作者

nigo（公众号：逆行的狗），公众号「逆行的狗」，专注审计行业效率工具与 AI 应用。
