...
> 作者：涂佳兵（nigo，公众号：逆行的狗）

本仓库收集了一套面向审计、财务、会计从业者的 AI Skills（技能）。所有 Skills 均由涂佳兵（nigo）制作，安装后 AI 助手将具备资深专家的分析视角与一整套实战工具，覆盖会计准则判断、审计实务、财报分析、关联方核查、报告勾稽、法规检索等高频场景。

## 关于作者

涂佳兵（nigo），公众号「逆行的狗」，专注审计行业效率工具与 AI 应用。

- 系统学习 AI Agent 课程（文字版教程）：https://course.auditdog.cn/
- AI Agent 实操课程：https://m.tenclass.cn/channel2/1880290
